...
function createMultiSelect() {
    ...
    var opt1 = new Option('Sushi', 'Sushi');
    var opt2 = new Option('Steak', 'Steak');
    var opt3 = new Option('Sphagetti', 'Sphagetti');
    var opt4 = new Option('Pizza', 'Pizza');
    var opt5 = new Option('Mac & Cheese', 'mac & Cheese');
    opt5.selected = true;
...
function createState() {
    ...
    select.id = 'state'
    select.setAttribute('class', 'form-control col-6')
    var opt1 = new Option('Goa', 'Goa');
    var opt2 = new Option('Tamil nadu', 'Tamil nadu');
    var opt3 = new Option('Noida', 'Noida');
    var opt4 = new Option('Haryana', 'Haryana');
    var opt5 = new Option('Madhya Pradesh', 'Madhya Pradesh');
    var opt6 = new Option('Delhi', 'Delhi');
    var opt7 = new Option('Telangana', 'Telangana');
    opt7.selected = true;
...
function createCountry() {
    ...
    select.setAttribute('class', 'form-control col-6')
    select.id = 'country'
    var opt1 = new Option('USA', 'USA');
    var opt2 = new Option('Canada', 'Canada');
    var opt3 = new Option('UAE', 'UAE');
    var opt4 = new Option('Ireland', 'Ireland');
    var opt5 = new Option('Malta', 'Malta');
    var opt6 = new Option('India', 'India');
    opt1.selected = true;
    var opt7 = new Option('Czech', 'Czech');
...
function action() {
    ...
    if (!fn) {
        ...
        alert('Your deatails has been recorded')
    }
